...
uint256 hashGenesisBlock("0xdf0743560893dcd00c904715f8359a2f4b9c20029d5870a26a4611f611d4ac3a");
...
{
    int64 nSubsidy = 1024 * COIN; //Amt of coins per block


    // Subsidy is cut in half every 524288 blocks
    nSubsidy >>= (nHeight / 524288);
...
static const int64 nTargetTimespan = 2048 * 8; // AltCoin: 2048 blocks
static const int64 nTargetSpacing = 8; // AltCoin: 8 seconds
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal AltCoin miner
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	CBlock(hash=14dc23f54de47df79717, PoW=00000aeb1f05fbf0b2fa, ver=1, 			hashPrevBlock=00000000000000000000, hashMerkleRoot=ef7e256a2c, 			nTime=1399574511, nBits=1e0ffff0, nNonce=2086299649, vtx=1)
  	...
  	vMerkleTree: ef7e256a2c */
        ...
        // Genesis block
        const char* pszTimestamp = "2018-01-05: Richard Freitag withdraws from The Four Hills Tournament";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1515145557;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2086648466;
        ...
        assert(block.hashMerkleRoot == uint256("0xbe007b4c3d9d598561399ee305ab9ffdf2322c144c090f6235c216c57b678c64"));
