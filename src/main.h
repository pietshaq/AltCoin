...
static const int64 MAX_MONEY = 1073741824 * COIN; // maximum of 1073741824 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 10800 / 250; // 10800 blocks found a day (1 block every 8 secs)./L. Priority cutoff is 1 LRC day / 250 bytes.
    }
